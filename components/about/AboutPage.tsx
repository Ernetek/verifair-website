...
export function AboutPage() {
  return (
    <div className="bg-white text-slate-950">
      ...
      <section className="bg-slate-950 py-16 text-white sm:py-20"><div className="container flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between"><div><h2 className="text-4xl font-black tracking-tight sm:text-5xl">Built for real projects. Engineered for what comes next.</h2></div><div className="flex flex-wrap gap-3"><Link href="/industries" className="cta-primary inline-flex min-h-12 items-center justify-center px-6 font-black">Explore VerifAir Solutions</Link><Link href="/contact" className="inline-flex min-h-12 items-center justify-center border border-white/40 font-black text-white hover:bg-white/10">Discuss Your Project</Link></div></div></section>
    </div>
  );
}
