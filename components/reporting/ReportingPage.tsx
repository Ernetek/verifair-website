          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-[0.28fr_0.72fr]">
            ...
            <div role="tabpanel" className="border border-slate-300 bg-slate-50 p-6 sm:p-8">
              <div className="flex flex-wrap items-start justify-between gap-4 border-b border-slate-300 pb-5">
                ...
                <p className="text-sm text-slate-500">Demonstration Project · neutral sample period</p>
              </div>
              <div className="mt-8 grid gap-8 sm:grid-cols-[0.7fr_1.3fr]">
                <div><p className="text-sm text-slate-500">Work Zone A · PM2.5 demonstration reading</p><p className="mt-2 text-4xl font-bold">18 <span className="text-base font-normal text-slate-500">{PARTICULATE_UNIT}</span></p></div>
